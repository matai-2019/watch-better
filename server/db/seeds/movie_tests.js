  ...
  return knex('movie_tests').del()
    .then(function () {
      return knex('movie_tests').insert([
        ...
        { id: 2, test_type: 'Bechdel Test', movie_id: 2, result: true },
        { id: 3, test_type: 'Bechdel Test', movie_id: 3, result: true },
        { id: 4, test_type: 'Duvernay Test', movie_id: 4, result: true },
        { id: 5, test_type: 'Duvernay Test', movie_id: 5, result: true },
        { id: 6, test_type: 'Duvernay Test', movie_id: 6, result: true },
        { id: 7, test_type: 'Bechdel Test', movie_id: 7, result: true },
        { id: 8, test_type: 'Bechdel Test', movie_id: 8, result: true },
        { id: 9, test_type: 'Bechdel Test', movie_id: 9, result: true },
        { id: 10, test_type: 'Bechdel Test', movie_id: 10, result: true }
      ])
    })
}
